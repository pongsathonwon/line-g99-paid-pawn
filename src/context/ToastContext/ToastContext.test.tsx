...
describe("test useToast hook", () => {
  ...
  describe("test remove toast", () => {
    it("should correclty remove toast", () => {
      ...
      expect(result.current.toasts.map(({ message }) => message)).toStrictEqual(
        ["toast-1", "toast-3"]
      );
    });
  });
  ...
  describe("test automatic remove toast", () => {
    ...
    it("should clear toast", () => {
      ...
      act(() => {
        result.current.success("toast-1", 1000); // removed after 2 ticks
        result.current.success("toast-2", 2000); // removed after 3 ticks
        result.current.success("toast-3", 1000); // removed after 2 ticks
      });
    ...
    it("should clear the interval on unmount", () => {
      ...
      // Add a toast to trigger the interval
      act(() => {
        result.current.success("toast-1", 5000);
      });
